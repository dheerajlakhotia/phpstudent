		...
		<div class="container" style="" id="home">
			...
			<form method="post" style="max-width: 600px;">
				<div class="row">
					...
					<div class="col-75">
						<input type="text" value="<?php echo $fristname; ?>" class="form-input" id="Fristname" name="name" placeholder="Enter Your Frist Name" autocomplete="off"><br>
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" value="<?php echo $lastname; ?>" class="form-input" id="lname" name="lname" placeholder="Enter Your Last Name" autocomplete="chrome-off"><br>
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" class="form-input" id="fname" name="fname" placeholder="Enter Your Father Name"  value="<?php echo $fname; ?>" autocomplete="chrome-off"><br>
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" value="<?php echo $mob; ?>" class="form-input" id="mob" name="mob" placeholder="Enter Your Mobile" autocomplete="chrome-off"><br>
						<span id="valmob"></span>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="email" value="<?php echo $email; ?>" class="form-input" id="email" name="email" placeholder="Enter Your Email" autocomplete="chrome-off"><br>
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" value="<?php echo $address; ?>" class="form-input" id="address" name="address" placeholder="Enter Your Address" autocomplete="chrome-off"><br>
						<span id="valadd"></span>
					</div>
				</div>
				<div class="row">
						...
						if ($result->num_rows > 0){
							while ($row = $result->fetch_assoc()) {?>
								<tr>
									...
									<a href="index.php?id=<?php echo $row["id"];?>&&type=delete"><button class="delete">Delete</button></a></td>
								</tr>
						<?php }} ?>
				</tbody>
			</table>
